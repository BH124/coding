                    ...
                    <ul id="sidebarnav">
                        <li>
                            <a class="waves-effect waves-dark" href="index.php" aria-expanded="false">
                                <i class="fa fa-tachometer"></i><span class="hide-menu">Dash board</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="edit_profile_admin.php" aria-expanded="false">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $name; ?>" class="form-control form-control-line">
                                        </div>
                                        <div class="form-group">
